...
@receiver(post_delete, sender=LeaveReportStaff)
def reset_sequence(sender, instance, **kwargs):
    # Reset the auto-increment sequence for the table after each delete
    from django.db import connection
    cursor = connection.cursor()
    table_name = f'{sender._meta.app_label}_{sender._meta.model_name}'
