...
urlpatterns = [
    ...
    path('reset_leave_applications/', HodViews.reset_leave_applications, name='reset_leave_applications'),
    ...
    path('cancel_leave_application/<int:leave_id>/', StaffViews.cancel_leave_application, name='cancel_leave_application'),
